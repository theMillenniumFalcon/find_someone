...
import { ScrollView, View, FlatList, RefreshControl, Dimensions, TouchableOpacity, Pressable, Image, Alert } from "react-native"
import { useTheme, Text, Button, Chip, Card, Menu } from "react-native-paper"
import { SwiperFlatList } from 'react-native-swiper-flatlist'
import { MaterialCommunityIcons } from "@expo/vector-icons"

import { UserMiscInfoEnum, UserInterest, UnitsEnum, ProfileResource, UserDto, UserImage } from "../types/types"
import * as I18N from "../i18n"
import * as Global from "../utils/Global"
import * as URL from "../utils/URL"
import styles, { DISLIKE_ACTIONS, LIKE_ACTIONS, GRAY, DIMENSION_WIDTH, STATUS_BAR_HEIGHT } from "../assets/styles"
...
const Profile = ({ route, navigation }: any) => {
    ...
    const [you, setYou] = useState<UserDto>()
    ...
    const [preferredGenders, setPreferredGenders] = useState(Array<Gender>)
    const [relationshipString, setRelationshipString] = useState<String>()
    const [kidsString, setKidsString] = useState<String>()
    const [drugsString, setDrugsString] = useState<String>()
