...
import { View, RefreshControl, KeyboardAvoidingView, Keyboard, Dimensions, Image } from "react-native"
import { TextInput, Card } from "react-native-paper"
import { useTheme, Text } from "react-native-paper"
import { ScrollView } from "react-native-gesture-handler"

import { MessageDtoListModel, MessageDto } from "../types/types"
...
const MessageDetail = ({ route, navigation }: any) => {
    ...
    const [results, setResults] = useState(Array<MessageDto>)
    let scrollViewRef = useRef(null) as any
